...
public class MainActivity extends Activity {
	...
	public void onResume() {
		...
		sndBackground = new SoundPlayer();sndBackground.playLooped(this, "main_background");
	} // end onResume method.
	...
	public void onCheckboxClicked(View view) {
		...
		case R.id.cbtGotIt:
			if (checked) {
				set.saveBooleanSettings("wasAnnounced" + curVer, true);
			} else {
				set.saveBooleanSettings("wasAnnounced" + curVer, false);
			}
			break;
		} // end switch.
